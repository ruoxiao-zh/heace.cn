...
class ArticleCategoriesController extends Controller
{
    ...
    public function index(Request $request, ArticleCategory $articleCategory)
    {
        ...
        return $this->response->collection($articleCategories, new ArticleCategoryTransformer());
    }
    ...
    public function subcategories(ArticleCategory $articleCategory)
    {
        $query = $articleCategory->query();
        $articleCategories = $query->where('pid', $articleCategory->id)->get();
